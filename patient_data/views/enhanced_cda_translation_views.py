...
from translation_services.terminology_translator import get_available_translation_languages
...
def patient_cda_translated_view(request, patient_id):
    ...
    try:
        ...
        translation_service = EnhancedCDATranslationService(target_language=target_language)
...
def download_translated_cda(request, patient_id):
    ...
    try:
        ...
        if format_type == 'json':
            ...
            response['Content-Disposition'] = f'attachment; filename="translated_cda_{patient_id}_{target_language}.json"'
            
        elif format_type == 'xml':
            # Return translated XML
            response = HttpResponse(
                translated_document.translated_xml,
                content_type='application/xml'
            )
            response['Content-Disposition'] = f'attachment; filename="translated_cda_{patient_id}_{target_language}.xml"'
            ...
            response['Content-Disposition'] = f'attachment; filename="translated_cda_{patient_id}_{target_language}.txt"'
        ...
        return redirect('patient_data:patient_cda_translated_view', patient_id=patient_id)
...
def batch_translate_documents(request):
    ...
    if request.method == 'POST':
        try:
                ...
                try:
                    ...
                    if match_data:
                        ...
                        translation_results.append({
                            ...
                            'sections_translated': translated_document.translation_summary['translated_sections'],
            ...
            return render(request, 'patient_data/batch_translation_results.html', context, using='jinja2')
        ...
        return render(request, 'patient_data/batch_translation_form.html', using='jinja2')
