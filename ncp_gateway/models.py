...
class Patient(models.Model):
    ...
    national_id = models.CharField(max_length=50, help_text="National patient identifier")
    european_id = models.CharField(max_length=100, unique=True, null=True, blank=True, 
    ...
    # Consent and privacy
    cross_border_consent = models.BooleanField(default=False, 
                                             help_text="Consent for cross-border data sharing")
...
class CrossBorderRequest(models.Model):
    ...
    # Request details
    requesting_country = models.ForeignKey(Country, on_delete=models.CASCADE, 
                                         related_name='outgoing_requests')
    target_country = models.ForeignKey(Country, on_delete=models.CASCADE, 
                                     related_name='incoming_requests')
    patient = models.ForeignKey(Patient, on_delete=models.CASCADE)
    requesting_professional = models.ForeignKey(HealthcareProfessional, on_delete=models.CASCADE)
    ...
    response_data = models.JSONField(null=True, blank=True, help_text="FHIR response payload")
...
class AuditLog(models.Model):
    ...
    professional = models.ForeignKey(HealthcareProfessional, on_delete=models.SET_NULL, 
                                   null=True, blank=True)
    patient = models.ForeignKey(Patient, on_delete=models.SET_NULL, null=True, blank=True)
    
    # Event data
    description = models.TextField()
    data_accessed = models.TextField(null=True, blank=True, help_text="Description of data accessed")
    ...
    cross_border_request = models.ForeignKey(CrossBorderRequest, on_delete=models.SET_NULL, 
                                           null=True, blank=True)
    source_country = models.ForeignKey(Country, on_delete=models.SET_NULL, 
                                     related_name='audit_logs_source', null=True, blank=True)
    target_country = models.ForeignKey(Country, on_delete=models.SET_NULL, 
                                     related_name='audit_logs_target', null=True, blank=True)
