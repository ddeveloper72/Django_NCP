...
def analyze_coded_participants():
    ...
    try:
        ...
        for i, participant in enumerate(participants, 1):
            ...
            function_code = function_code_elem.get('code') if function_code_elem is not None else None
            ...
            class_code = entity_elem.get('classCode') if entity_elem is not None else None
