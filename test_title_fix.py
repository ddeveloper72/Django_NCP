...
def test_title_handling():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "section": {"section_code": "", "content": {"original": "Test content"}},
        },
    ]
    ...
    for test_case in test_cases:
        ...
        try:
            ...
            print(
                f"✅ render_section: Success - {result.get('section_type', 'unknown')}"
            )

            # Test render_section_tables
            result_tables = renderer.render_section_tables([test_case["section"]])
            print(
                f"✅ render_section_tables: Success - {len(result_tables)} sections rendered"
            )
