...
def test_enhanced_table_population():
    ...
    try:
        ...
        for lang in languages:
            ...
            medication_html = generate_test_table(test_data["medication"], "10160-0", lang)
            ...
            procedure_html = generate_test_table(test_data["procedure"], "47519-4", lang)
...
def generate_test_table(table_data, section_code, language):
    ...
    def get_section_column_headers(section_code, target_language="en"):
        headers_map = {
            "en": {
                "10160-0": ["Medication", "Active Ingredient", "Dosage", "Posology", "Status"],
                "48765-2": ["Allergy Type", "Causative Agent", "Manifestation", "Severity", "Status"],
