    ...
    try:
        ...
        mock_match_data = {
            ...
            "patient_data": {
                ...
                "birth_date": (
                    test_patient.birth_date.strftime("%Y-%m-%d")
                    if test_patient.birth_date
                    else "Unknown"
                ),
        ...
        print(
            f"   Secondary ID: {mock_match_data['patient_data']['secondary_patient_id']}"
        )
            ...
            if hasattr(response, "context_data"):
                ...
                if "patient_identity" in context:
                    ...
                    if primary_id == "DE123456789":
                        ...
                        print(
                            f"❌ Primary patient ID mismatch: expected 'DE123456789', got '{primary_id}'"
                        )
                        return False
                    ...
                    if secondary_id == "NHS987654321":
                        ...
                        print(
                            f"❌ Secondary patient ID mismatch: expected 'NHS987654321', got '{secondary_id}'"
                        )
                        return False
